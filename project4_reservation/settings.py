...
ALLOWED_HOSTS =["127.0.0.1", '8000-bobrac3023-project4rosh-u31s29dj3zv.ws.codeinstitute-ide.net',
    '.herokuapp.com']
...
SITE_ID = 1
LOGIN_REDIRECT_URL = '/reservation/form/'  # or where you want to go after login
LOGOUT_REDIRECT_URL = '/'
